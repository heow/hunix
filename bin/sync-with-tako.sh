...
sync-git-host heow@tako ~/.hunix/bin 
sync-git-host heow@tako ~/.hunix/etc
sync-git-host heow@tako ~/prj-personal/doc-wiki
sync-git-host heow@tako ~/prj-work/doc-wiki 
